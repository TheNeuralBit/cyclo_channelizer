...
structure can be seen in Figure~\ref{fig:runtime_comparison_250}. The plot shows the
...
signals the polyphase structure is less efficient.  However, each additional
...
efficient power of two FFT size. Figure~\ref{fig:fft_runtime} illustrates the
