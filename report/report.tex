...
runtime for using both structures to simultaneously detect and tune various
...
\begin{figure}[h!]
    ...
    \caption{Runtime comparison of detector combined with the Overlap-Save
             Filter Bank and with the Polyphase Analysis/Synthesis Channelizer}
    \label{fig:block_diagram}
\end{figure}
...
expensive to perform the large Polyphase Analysis Channelizer just to recombine
two or three signals. However, each addiditional signal costs more time for the 
Overlap-Save Filter Bank to process than the Polyphase Channelizer. When 
