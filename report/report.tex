...
these SCD estimates (e.g. \cite{Thai1,Yoo1}). In this paper we are primarily concerned
with efficiently estimating the SCD, so we choose to use a relatively na{\"i}ve
approach: a thresholded peak detection that favors the higher cyclic frequency
